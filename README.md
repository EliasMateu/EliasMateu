...
║                                                       ║
║   > whoami                                            ║
║   Elias Mateus Machado Gonçalves                      ║
║   Full Stack Developer  ·  Itaberá, SP                ║
║   _ ▌                                                 ║
║                                                       ║
╚═══════════════════════════════════════════════════════╝
```

[![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&size=18&pause=1000&color=00D4AA&center=true&vCenter=true&width=600&lines=Full+Stack+Developer+%F0%9F%9A%80;Node.js+%7C+TypeScript+%7C+Vue+%7C+Java;Apaixonado+por+resolver+problemas+reais;Sempre+aprendendo%2C+sempre+construindo...)](https://git.io/typing-svg)
...
```
┌─────────────────────────────────────────────────────────────────┐
│  ♻️  EcoColeta — TCC · Melhor da turma                          │
├─────────────────────────────────────────────────────────────────┤
│                                                                 │
│  Aplicativo mobile que conecta moradores, prefeituras           │
│  e coletores de resíduos recicláveis.                           │
│                                                                 │
│  ✦ Mapa interativo para sinalização de pontos de coleta         │
│  ✦ Categorização por tipo de material (papel, plástico…)        │
│  ✦ Interface para coletores otimizarem rotas                    │
│  ✦ Painel para gestão municipal                                 │
│                                                                 │
│  [ Impacto social real + Tecnologia mobile + UX pensada ]       │
└─────────────────────────────────────────────────────────────────┘
```
...
[![Gmail](https://img.shields.io/badge/Gmail-D14836?style=for-the-badge&logo=gmail&logoColor=white)](mailto:elias.mateus.dev@gmail.com)
[![GitHub](https://img.shields.io/badge/GitHub-100000?style=for-the-badge&logo=github&logoColor=white)](https://github.com/EliasMateu)
...
# Cada linha é um problema resolvido. 🚀
```
